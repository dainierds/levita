...
import { UserCheck, Mic2, Music, Mic, ChevronRight, Calendar, Info, CheckCircle2 } from 'lucide-react';
...
const ROLES_CONFIG = [
    ...
    { key: 'musicDirector', label: 'Director de Música', icon: Music, color: 'text-pink-500 bg-pink-50', border: 'border-pink-100', role: 'MUSIC' },
...
const TeamRoster: React.FC<TeamRosterProps> = ({ users, settings, plans, savePlan }) => {
    ...
    const currentService = upcomingServices[activeDayIdx];
