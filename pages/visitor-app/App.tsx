    ...
    >
      ...
      {isActive && (
        <motion.div
          ...
          className="absolute -top-6 w-14 h-14 bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 rounded-full shadow-[0_10px_20px_-5px_rgba(79,70,229,0.4)] border-[3px] border-white"
