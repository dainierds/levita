...
import { Bell, Moon, Sun, Search, User, ArrowLeft } from 'lucide-react';
        ...
        <div className="flex flex-col h-screen overflow-hidden bg-neu-base dark:bg-neu-base-dark transition-colors duration-300 font-nunito selection:bg-brand-500 selection:text-white">
            ...
            <header className="flex-none h-24 flex items-center justify-between px-6 lg:px-10 z-10 relative">
                <div className="flex items-center">
                    {/* Back to Design Lab Button (Added for Sandbox Navigation) */}
                    <button
                        onClick={() => navigate('/design')}
                        className="mr-4 p-3 rounded-full text-red-400 hover:text-red-500 shadow-neu dark:shadow-neu-dark active:shadow-neu-pressed dark:active:shadow-neu-dark-pressed transition-all"
                    ...
                    <div className="mr-4 lg:hidden">
                        <div className="w-10 h-10 rounded-full bg-neu-base dark:bg-neu-base-dark shadow-neu dark:shadow-neu-dark flex items-center justify-center border-2 border-neu-base dark:border-neu-base-dark active:shadow-neu-pressed transition-all">
                            <span className="font-bold text-gray-400 dark:text-gray-500 text-sm">M</span>
                        </div>
                    </div>

                    <div className="">
                        <h1 className="text-xl md:text-2xl font-extrabold text-gray-700 dark:text-gray-200 tracking-tight">
