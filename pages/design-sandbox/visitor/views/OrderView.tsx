...
export const OrderView: React.FC = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto py-4 relative">
            <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-2 bg-neu-base shadow-neu-pressed rounded-full" />
            <div className="space-y-12">
                {items.map((item, index) => (
                    <div key={index} className="flex md:justify-between items-center w-full">
                        <div className="w-full pl-20 md:pl-0 md:w-5/12">
                            <div className="p-6 rounded-[2rem] bg-neu-base shadow-neu hover:-translate-y-1 transition-transform">
