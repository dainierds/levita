    ...
    return (
        <div className="max-w-3xl mx-auto py-4">
            ...
            <div className="text-center mb-10">
                <h2 className="text-3xl font-black text-black dark:text-gray-200">Orden del Culto</h2>
                    ...
                    {items.map((item, index) => {
                        ...
                        `}>
                                        <div className="flex justify-between items-start mb-3">
                                            <h3 className={`font-bold text-lg ${isActive ? 'text-white' : 'text-black dark:text-gray-200'}`}>
                                                {item.title}
                                            </h3>
